		...
		while (abbruch2 == 0):
			...
			# Optionen abfragen
				...
				if (auswahl_menu == 8):
					...
					display_erase()
					lcd_byte(DISPLAY_LINE_1, DISPLAY_CMD)
					lcd_string("Bluetooth gestartet")
					lcd_byte(DISPLAY_LINE_2, DISPLAY_CMD)
					lcd_string("--------------------")
					lcd_byte(DISPLAY_LINE_3, DISPLAY_CMD)
					lcd_string("Bitte Taste druecken")
					lcd_byte(DISPLAY_LINE_4, DISPLAY_CMD)
					lcd_string("--------------------")
					# Bluetooth starten
					subprocess.call("bluealsa-aplay 00:00:00:00:00:00", shell=True)
					while (taste1 == 0 and taste2 == 0 and taste3 == 0 and taste4 == 0):
						time.sleep(0.1)			
					# Bluetooth stoppen
					subprocess.call("pkill bluealsa-aplay", shell=True)
